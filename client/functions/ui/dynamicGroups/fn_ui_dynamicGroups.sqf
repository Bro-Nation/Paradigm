...
switch _mode do
{
	case "onLoad":
	{
		...
		// Reset
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_SELECTED_MEMBER_VAR, nil];
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_SELECTED_PLAYER_VAR, nil];
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_SELECTED_GROUPORPLAYER_VAR, nil];

		// Sections
		private ["_sectionGroups", "_sectionManage"];
		_sectionGroups = _display displayCtrl PARA_C_DYNAMICGROUPS_SECTIONGROUPS_IDC;
		_sectionManage = _display displayCtrl PARA_C_DYNAMICGROUPS_SECTIONMANAGE_IDC;

		// List boxes
		private ["_groupsListbox", "_playersListbox", "_manageListbox"];
		_groupsListbox 	= _display displayCtrl PARA_C_DYNAMICGROUPS_LISTBOXGROUPS_IDC;
		_playersListbox	= _display displayCtrl PARA_C_DYNAMICGROUPS_LISTBOXPLAYERS_IDC;
		_manageListbox 	= _display displayCtrl PARA_C_DYNAMICGROUPS_LISTBOXMANAGE_IDC;
		...
		_createLeaveKickButton 	= _display displayCtrl PARA_C_DYNAMICGROUPS_BUTTONCREATELEAVEKICK_IDC;
		_promoteDisbandButton 	= _display displayCtrl PARA_C_DYNAMICGROUPS_BUTTONPROMOTEDISBAND_IDC;
		_joinButton 			= _display displayCtrl PARA_C_DYNAMICGROUPS_BUTTONJOIN_IDC;
		_kickPlayerButton 		= _display displayCtrl PARA_C_DYNAMICGROUPS_BUTTONKICK_IDC;
		_invitePlayerButton 	= _display displayCtrl PARA_C_DYNAMICGROUPS_BUTTONINVITE_IDC;
		_closeInterfaceButton 	= _display displayCtrl PARA_C_DYNAMICGROUPS_CLOSEINTERFACE_IDC;
		_tabGroupsButton 		= _display displayCtrl PARA_C_DYNAMICGROUPS_TABBUTTONGROUPS_IDC;
		_tabPlayersButton 		= _display displayCtrl PARA_C_DYNAMICGROUPS_TABBUTTONPLAYERS_IDC;
		...
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_SHOW_GROUPS_VAR, true];
		...
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_COLLAPSED_GROUPS_VAR, []];
	...
	case "onUnload":
	{
		...
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_UI_DISPLAY_VAR, nil];
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_HAS_FOCUS_VAR, nil];
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_OLD_GROUPS_LIST_VAR, nil];
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_OLD_GROUPS_PLAYERS_LIST_VAR, nil];
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_OLD_PLAYERS_LIST_VAR, nil];
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_OLD_MEMBERS_LIST_VAR, nil];
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_SHOW_GROUPS_VAR, nil];
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_COLLAPSED_GROUPS_VAR, nil];
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_LAST_PLAYER_GROUP_VAR, nil];
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_SELECTED_MEMBER_VAR, nil];
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_SELECTED_PLAYER_VAR, nil];
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_SELECTED_GROUPORPLAYER_VAR, nil];
	...
	case "GetDisplay" :
	{
		uiNamespace getVariable [PARA_C_DYNAMICGROUPS_UI_DISPLAY_VAR, displayNull];
	};
	...
	case "CloseDisplay" :
	{
		(uiNamespace getVariable [PARA_C_DYNAMICGROUPS_UI_DISPLAY_VAR, displayNull]) closeDisplay IDC_CANCEL;
	};
	...
	case "Update" :
	{
		...
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_LAST_PLAYER_GROUP_VAR, group player];
	};
	...
	case "UpdateManageSection" :
	{
		...
		_sectionManage 			= _display displayCtrl PARA_C_DYNAMICGROUPS_SECTIONMANAGE_IDC;
		_buttonPromoteDisband	= _display displayCtrl PARA_C_DYNAMICGROUPS_BUTTONPROMOTEDISBAND_IDC;
		_buttonInvite 			= _display displayCtrl PARA_C_DYNAMICGROUPS_BUTTONINVITE_IDC;
		_buttonCreateLeaveKick	= _display displayCtrl PARA_C_DYNAMICGROUPS_BUTTONCREATELEAVEKICK_IDC;
		_editGroupName 			= _display displayCtrl PARA_C_DYNAMICGROUPS_EDITGROUPNAME_IDC;
		_textNumberOfPlayers 	= _display displayCtrl PARA_C_DYNAMICGROUPS_TEXTPLAYERCOUNT_IDC;
		_listBoxMembers			= _display displayCtrl PARA_C_DYNAMICGROUPS_LISTBOXMANAGE_IDC;
		_listBoxGroups 			= _display displayCtrl PARA_C_DYNAMICGROUPS_LISTBOXGROUPS_IDC;
		_listBoxPlayers			= _display displayCtrl PARA_C_DYNAMICGROUPS_LISTBOXPLAYERS_IDC;
		_checkboxPrivate 		= _display displayCtrl PARA_C_DYNAMICGROUPS_CHECKBOXPRIVATE_IDC;
		_sidePicture 			= _display displayCtrl PARA_C_DYNAMICGROUPS_PICTURESIDE_IDC;
		_groupIcon				= _display displayCtrl PARA_C_DYNAMICGROUPS_GROUPICON_IDC;
		_fillPlayerName			= _display displayCtrl PARA_C_DYNAMICGROUPS_TEXTPLAYERNAMEFILL_IDC;
		_fillPlayerSide			= _display displayCtrl PARA_C_DYNAMICGROUPS_TEXTPLAYERSIDEFILL_IDC;
		_fillPlayerScore		= _display displayCtrl PARA_C_DYNAMICGROUPS_TEXTPLAYERSCOREFILL_IDC;
		...
		if (!_playerGroupRegistered) then
		{
			...
			_sectionManage ctrlCommit PARA_C_DYNAMICGROUPS_SECTION_FADE_TIME;
			...
			_groupIcon ctrlSetText "vn\data_f_vietnam\logos\vn_over_co.paa";
		}
		else
		{
			...
			_groupPicture 	= _playerGroup getVariable [PARA_C_DYNAMICGROUPS_GROUP_INSIGNIA_VAR, ""];
			_groupIsPrivate = _playerGroup getVariable [PARA_C_DYNAMICGROUPS_GROUP_PRIVATE_VAR, false];
			...
			uiNamespace setVariable [PARA_C_DYNAMICGROUPS_OLD_MEMBERS_VAR, _groupPlayers];
			uiNamespace setVariable [PARA_C_DYNAMICGROUPS_OLD_GROUP_VAR, _playerGroup];
			...
			_checkboxPrivate ctrlEnable (_playerIsLeader && {!(missionNamespace getVariable [PARA_C_DYNAMICGROUPS_MINIMAL_INTERACTION_VAR, false])});
			...
			private _lastPlayerGroup = uiNamespace getVariable [PARA_C_DYNAMICGROUPS_LAST_PLAYER_GROUP_VAR, grpNull];
			...
			if (_playerIsLeader && {!(missionNamespace getVariable [PARA_C_DYNAMICGROUPS_MINIMAL_INTERACTION_VAR, false])}) then
			{
			...
			// Set the group icon
			private _insignia = missionNamespace getVariable [PARA_C_DYNAMICGROUPS_FORCED_INSIGNIA_VAR, ""];
	...
	case "UpdateGroupsSection" :
	{
		...
		private "_display";
		_display = uiNamespace getVariable [PARA_C_DYNAMICGROUPS_UI_DISPLAY_VAR, displayNull];
		CHECK(isNull _display)

		private ["_sectionGroups", "_buttonJoin", "_playersListbox"];
		_sectionGroups 	= _display displayCtrl PARA_C_DYNAMICGROUPS_SECTIONGROUPS_IDC;
		_buttonJoin 	= _display displayCtrl PARA_C_DYNAMICGROUPS_BUTTONJOIN_IDC;
		_playersListbox	= _display displayCtrl PARA_C_DYNAMICGROUPS_LISTBOXPLAYERS_IDC;

		// Show groups section
		_sectionGroups ctrlShow true;
		_sectionGroups ctrlSetFade 0;
		_sectionGroups ctrlCommit PARA_C_DYNAMICGROUPS_SECTION_FADE_TIME;
		...
		if (uiNamespace getVariable [PARA_C_DYNAMICGROUPS_SHOW_GROUPS_VAR, true]) then
		{
			["OnTabGroupsButtonClick"] call DISPLAY;

			["FillPlayersListbox", [_playersListbox, _sidePlayers]] call DISPLAY;
			uiNamespace setVariable [PARA_C_DYNAMICGROUPS_OLD_PLAYERS_VAR, _sidePlayers];

			["FillGroupsListbox", [_friendlyGroups, _unsortedPlayers]] call DISPLAY;
			uiNamespace setVariable [PARA_C_DYNAMICGROUPS_OLD_GROUPS_VAR, [_friendlyGroups, _unsortedPlayers]];
		}
		else
		{
	...
	case "FillGroupsListbox" :
	{
		...
		private "_listbox";
		_listbox = _display displayCtrl PARA_C_DYNAMICGROUPS_LISTBOXGROUPS_IDC;
		...
		// Add them to the list box
		{
			...
			_groupPicture 	= _x getVariable [PARA_C_DYNAMICGROUPS_GROUP_INSIGNIA_VAR, ["LoadRandomInsignia"] call GROUPS];
			_groupIsPrivate = _x getVariable [PARA_C_DYNAMICGROUPS_GROUP_PRIVATE_VAR, false];
			...
			_maxUnitCount	= missionNamespace getVariable [PARA_C_DYNAMICGROUPS_MAX_UNITS_PER_GROUP_VAR, 99];
			_isFull			= count units _x >= _maxUnitCount;
			_autoName		= if (_maxUnitCount < 99) then { format ["%1  (%2/%3)", _groupName, count units _x, missionNamespace getVariable [PARA_C_DYNAMICGROUPS_MAX_UNITS_PER_GROUP_VAR, 99]] } else { _groupName };

			// Selected group?
			if ((uiNamespace getVariable [PARA_C_DYNAMICGROUPS_SELECTED_GROUPORPLAYER_VAR, [grpNull, objNull]]) select 0 == _x) then
			{
			...
			if (_locked) then { _listbox tvSetPictureColor [[_parent], PARA_C_DYNAMICGROUPS_COLOR_LOCKED]; } else { _listbox tvSetPictureColor [[_parent], [1,1,1,1]]; };
			_listbox tvSetPictureColorSelected [[_parent], [1,1,1,1]];
			_listbox tvSetPictureColorDisabled [[_parent], [1,1,1,1]];
			if (_x in (uiNamespace getVariable [PARA_C_DYNAMICGROUPS_COLLAPSED_GROUPS_VAR, []])) then { _listbox tvCollapse [_parent]; } else { _listbox tvExpand [_parent]; };

			{
				...
				_groupPlayerIcon	= if (!_isLeader) then { ["GetPlayerIcon", [_x]] call DISPLAY; } else { PARA_C_DYNAMICGROUPS_ICON_GENERAL; };
				_isDead				= !alive _x;
				_isIncapacitated	= alive _x && _x getVariable ["BIS_revive_incapacitated", false];

				private _color = switch (true) do
				{
					case (_isDead) : 			{ PARA_C_DYNAMICGROUPS_COLOR_DEAD };
					case (_isIncapacitated) : 	{ PARA_C_DYNAMICGROUPS_COLOR_INCAPACITATED };
					case (player == _x) : 		{ PARA_C_DYNAMICGROUPS_COLOR_SELF };
					case (_sameGroup) : 		{ PARA_C_DYNAMICGROUPS_COLOR_GROUP };
					default 					{ PARA_C_DYNAMICGROUPS_COLOR_DEFAULT_ARRAY };
				};

				// Selected player?
				if ((uiNamespace getVariable [PARA_C_DYNAMICGROUPS_SELECTED_GROUPORPLAYER_VAR, [grpNull, objNull]]) select 1 == _x) then
				{
				...
				if (_isDead) then
				{
					...
					_groupPlayerIcon = PARA_C_DYNAMICGROUPS_ICON_KIA;
				}
				else
				{
					if (_isIncapacitated) then { _groupPlayerIcon = PARA_C_DYNAMICGROUPS_ICON_REVIVE; };
				};
		...
		if (count _unsortedPlayers > 0) then
		{
			...
			private _parent = _listbox tvAdd [[], PARA_C_DYNAMICGROUPS_UNSORTED_GROUP_ID];
			_listbox tvSetData [[_parent], PARA_C_DYNAMICGROUPS_UNSORTED_GROUP_ID];
			_listbox tvSort [[_parent], true];
			...
			// Selected group?
			if (isNull ((uiNamespace getVariable [PARA_C_DYNAMICGROUPS_SELECTED_GROUPORPLAYER_VAR, [grpNull, objNull]]) select 0)) then
			{
...

			{
				...
				if (_isDead) then
				{
					...
					_unsortedPlayerIcon = PARA_C_DYNAMICGROUPS_ICON_KIA;
				}
				else
				{
					if (_isIncapacitated) then { _unsortedPlayerIcon = PARA_C_DYNAMICGROUPS_ICON_REVIVE; };
				};
				...
				if (PARA_C_DYNAMICGROUPS_UNSORTED_GROUP_ID in (uiNamespace getVariable [PARA_C_DYNAMICGROUPS_COLLAPSED_GROUPS_VAR, []])) then
				{
	...
	case "FillPlayersListbox" :
	{
		...
		_targetVar	= if (_isManageSection) then { PARA_C_DYNAMICGROUPS_SELECTED_MEMBER_VAR } else { PARA_C_DYNAMICGROUPS_SELECTED_PLAYER_VAR };
		_targetList	= if (_isManageSection) then { PARA_C_DYNAMICGROUPS_OLD_MEMBERS_LIST_VAR } else { PARA_C_DYNAMICGROUPS_OLD_PLAYERS_LIST_VAR };
		...
		if !(_newPlayersList isEqualTo _oldPlayersList) then
		{
			...
			// Fill listbox
			{
				...
				if (_isDead) then
				{
					...
					_texture = PARA_C_DYNAMICGROUPS_ICON_KIA;
				}
				else
				{
					if (_isIncapacitated) then { _texture = PARA_C_DYNAMICGROUPS_ICON_REVIVE; };
				};
	...
	case "TreeDeleteGroup" :
	{
		...
		{
			private _display = uiNamespace getVariable [PARA_C_DYNAMICGROUPS_UI_DISPLAY_VAR, displayNull];
			private _listbox = _display displayCtrl PARA_C_DYNAMICGROUPS_LISTBOXGROUPS_IDC;
	...
	case "OnGroupsTreeSelChanged" :
	{
		...
		_display 		= uiNamespace getVariable [PARA_C_DYNAMICGROUPS_UI_DISPLAY_VAR, displayNull];
		_inviteButton 	= _display displayCtrl PARA_C_DYNAMICGROUPS_BUTTONINVITE_IDC;
		_joinButton 	= _display displayCtrl PARA_C_DYNAMICGROUPS_BUTTONJOIN_IDC;
		...
		if (_data == PARA_C_DYNAMICGROUPS_UNSORTED_GROUP_ID) exitWith
		{
			uiNamespace setVariable [PARA_C_DYNAMICGROUPS_SELECTED_GROUPORPLAYER_VAR, [grpNull, objNull]];
		};
		...
		if (!isNull _group) then
		{
			...
			_groupIsPrivate 	= _group getVariable [PARA_C_DYNAMICGROUPS_GROUP_PRIVATE_VAR, false];
			...
			_isFull				= count units _group >= missionNamespace getVariable [PARA_C_DYNAMICGROUPS_MAX_UNITS_PER_GROUP_VAR, 99];

			// Store the newly selected group
			uiNamespace setVariable [PARA_C_DYNAMICGROUPS_SELECTED_GROUPORPLAYER_VAR, [_group, objNull]];
		...
		else
		{
			...
			uiNamespace setVariable [PARA_C_DYNAMICGROUPS_SELECTED_GROUPORPLAYER_VAR, [group _player, _player]];
	...
	case "OnPlayersLbSelChanged" :
	{
		...
		// Store the newly selected player
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_SELECTED_PLAYER_VAR, _clickedPlayer];
	...
	case "OnManageLbSelChanged" :
	{
		...
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_SELECTED_MEMBER_VAR, _clickedPlayer];
		...
		if (_clickedPlayer == player) then
		{
			...
			{
				_buttonCreateLeaveKick ctrlEnable !(missionNamespace getVariable [PARA_C_DYNAMICGROUPS_MINIMAL_INTERACTION_VAR, false]);
			...
			else
			{
				...
				{
					_buttonPromoteDisband ctrlEnable !(missionNamespace getVariable [PARA_C_DYNAMICGROUPS_MINIMAL_INTERACTION_VAR, false]);
					_buttonPromoteDisband ctrlSetText localize "STR_A3_RscDisplayDynamicGroups_Button_Disband";
					_buttonPromoteDisband ctrlSetTooltip localize "STR_A3_RscDisplayDynamicGroups_Tooltip_KickAll";
				};
			};
	...
	case "OnCreateLeaveKickButtonClick" :
	{
		...
		_display 	= uiNamespace getVariable [PARA_C_DYNAMICGROUPS_UI_DISPLAY_VAR, displayNull];
		_listbox 	= _display displayCtrl PARA_C_DYNAMICGROUPS_LISTBOXMANAGE_IDC;
	...
	case "OnInvitePlayerButtonClick" :
	{
		...
		_display 	= uiNamespace getVariable [PARA_C_DYNAMICGROUPS_UI_DISPLAY_VAR, displayNull];
		_isTree		= uiNamespace getVariable [PARA_C_DYNAMICGROUPS_SHOW_GROUPS_VAR, true];
		_listbox 	= if (_isTree) then { _display displayCtrl PARA_C_DYNAMICGROUPS_LISTBOXGROUPS_IDC; } else { _display displayCtrl PARA_C_DYNAMICGROUPS_LISTBOXPLAYERS_IDC; };
	...
	case "OnTabGroupsButtonClick" :
	{
		...
		_display 		= uiNamespace getVariable [PARA_C_DYNAMICGROUPS_UI_DISPLAY_VAR, displayNull];
		_listGroups		= _display displayCtrl PARA_C_DYNAMICGROUPS_LISTBOXGROUPS_IDC;
		_listPlayers	= _display displayCtrl PARA_C_DYNAMICGROUPS_LISTBOXPLAYERS_IDC;
		_buttonGroups	= _display displayCtrl PARA_C_DYNAMICGROUPS_TABBUTTONGROUPS_IDC;
		_buttonPlayers	= _display displayCtrl PARA_C_DYNAMICGROUPS_TABBUTTONPLAYERS_IDC;

		_listGroups ctrlShow true;
		_buttonGroups ctrlSetTextColor PARA_C_DYNAMICGROUPS_COLOR_DEFAULT_ARRAY;
	...
	case "OnTabPlayersButtonClick" :
	{
		...
		_buttonPlayers ctrlSetTextColor PARA_C_DYNAMICGROUPS_COLOR_DEFAULT_ARRAY;
		...
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_SHOW_GROUPS_VAR, false];
	};
	...
	case "OnGroupDoubleClick" :
	{
		...
		_groupPrivate 	= _group getVariable [PARA_C_DYNAMICGROUPS_GROUP_PRIVATE_VAR, false];
		_wasKickedFrom	= ["WasPlayerKickedFrom", [_group, player]] call GROUPS;
		_hasInvite	= ["HasInvite", [_group, player]] call GROUPS;
		_isFull		= count units _group >= missionNamespace getVariable [PARA_C_DYNAMICGROUPS_MAX_UNITS_PER_GROUP_VAR, 99];
	...
	case "OnPlayerDoubleClick" :
	{
		...
		if (_clickedPlayer != player) then
		{
			...
			_groupIsLocked	= (group _clickedPlayer) getVariable [PARA_C_DYNAMICGROUPS_GROUP_PRIVATE_VAR, false];
			_isFull			= count units (group _clickedPlayer) >= missionNamespace getVariable [PARA_C_DYNAMICGROUPS_MAX_UNITS_PER_GROUP_VAR, 99];
	...
	case "SetGroupName" :
	{
		...
		{
			// Lose focus
			ctrlSetFocus ((uiNamespace getVariable [PARA_C_DYNAMICGROUPS_UI_DISPLAY_VAR, displayNull]) displayCtrl PARA_C_DYNAMICGROUPS_LISTBOXMANAGE_IDC);
	...
	case "OnGroupNameChanged" :
	{
		...
		_backgroundGroupName = (uiNamespace getVariable [PARA_C_DYNAMICGROUPS_UI_DISPLAY_VAR, displayNull]) displayCtrl PARA_C_DYNAMICGROUPS_BACKGROUNDGROUPNAME_IDC;
		...
		[_backgroundGroupName, _editGroupName, if (_wasUpdated) then { _clampedGroupName } else { _oldGroupName }] spawn
		{
			...
			(_this select 1) ctrlSetTextColor PARA_C_DYNAMICGROUPS_COLOR_DEFAULT_ARRAY;
		};
	...
	case "OnGroupExpanded" :
	{
		...
		_collapsedGroups 	= uiNamespace getVariable [PARA_C_DYNAMICGROUPS_COLLAPSED_GROUPS_VAR, []];
		_group				= ["GetGroupByName", [_data, side group player]] call GROUPS;

		if (!isNull _group && {_group in _collapsedGroups}) then
		{
			_collapsedGroups deleteAt (_collapsedGroups find _group);
			uiNamespace setVariable [PARA_C_DYNAMICGROUPS_COLLAPSED_GROUPS_VAR, _collapsedGroups];
		};
	};
	...
	case "OnGroupNameSetFocus" :
	{
		...
		// Flag
		uiNamespace setVariable [PARA_C_DYNAMICGROUPS_HAS_FOCUS_VAR, true];
	...
	case "ClampString" :
	{
		...
		_maxSize 	= _params param [1, PARA_C_DYNAMICGROUPS_MAX_GROUP_NAME_SIZE, [0]];
